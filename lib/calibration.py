...
class Calibration:
    ...
    def map(self, i):
        ...
        if o[4] != None:
            self.crc = self.data[o[4] : o[4] + 2]
        else:
            self.crc = None
        if o[5] != None:
            self.magic = self.data[o[5] : o[5] + 4]
        else:
            self.magic = None
    ...
    def detect(self):
        ...
        for i in range(0, len(Calibration.offsets)):
            ...
            if (
                ...
                and (len(self.free) == 0 or self.free[0:4] == blank)
                and self.magic
                in [
                    None,
...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 6 and sys.argv[1] == "sign":
        ...
        if offset == None:
            print("CRC cmplwi not found!")
        else:
            print(f"CRC cmplwi offset: 0x{offset:06X}")
