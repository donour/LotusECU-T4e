...
\title{Lotus T4e ECU\\[0.5em]\large Engine Management \& Tuning Guide\\[0.5em]\normalsize Elise / Exige / 211 (Toyota 1ZZ-FE / 2ZZ-GE)\\\includegraphics[width=0.6\linewidth]{t4e.pdf}}
...
\begin{description}
	...
	\item[Zone 1] A separate formula based on coolant temperature, idle speed
